...
class FilmController
{
   ...
   //funcio per a la vista edit
    public function edit($id)
    {
        ...
        //busquem la peli
        $film = Film::find($id);
        $genres = Film::getGenres($id);
        $allGenres = Film::getAllGenres();
        ...
        return view('films/edit', ['film' => $film,'genres'=>$genres,'allGenres'=>$allGenres]);
    }
    ...
    public function show($id)
    {
        ...
        // retornem la vista i li passem la peli indicada
        return view('films/show', ['film' => $film, 'genres'=>$genres]);
    }
}